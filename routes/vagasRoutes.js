...
router.get('/vagas', listarVagas)//Mostra todas as vagas cadastradas.
router.get('/vagas/:id', listarVagaPorId)//Mostrar os detalhes de uma vaga pelo seu ID.
...
router.get('/localizacao/:cidade', listarVagaPorCidade)//Listar as vagas disponíveis em uma cidade.
